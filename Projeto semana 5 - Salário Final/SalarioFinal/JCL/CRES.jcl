//HERC01C  JOB (SALRES),                                                00000101
//             'COMPILA SALRES',                                        00000200
//             CLASS=A,                                                 00000300
//             MSGCLASS=H,                                              00000400
...
//COB.SYSIN    DD DSN=HERC01.SALARIO.COBOL(SALRES),DISP=SHR             00001102
//LKED.SYSLIB  DD DSN=SYS1.COBLIB,DISP=SHR                              00001202
//             DD DSN=HERC01.SALARIO.LOAD,DISP=SHR                      00001302
//LKED.SYSLMOD DD DSN=HERC01.SALARIO.LOAD(SALRES),DISP=SHR              00001402
