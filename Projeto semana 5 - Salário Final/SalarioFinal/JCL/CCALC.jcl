//HERC01C  JOB (SALCALC),                                               00000101
//             'COMPILA SALCALC',                                       00000200
//             CLASS=A,                                                 00000300
//             MSGCLASS=H,                                              00000400
...
//COB.SYSIN    DD DSN=HERC01.SALARIO.COBOL(SALCALC),DISP=SHR            00001102
//LKED.SYSLIB  DD DSN=SYS1.COBLIB,DISP=SHR                              00001202
//             DD DSN=HERC01.SALARIO.LOAD,DISP=SHR                      00001302
//LKED.SYSLMOD DD DSN=HERC01.SALARIO.LOAD(SALCALC),DISP=SHR             00001402
